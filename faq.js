faq = [
	...
	{ q: 'What other simplifications were made to accomodate humans?',
	  a: 'Many. Three big ones would be: <blockquote>1. We don\'t consider probabilities of sentences, but rather only whether they are correct or not. This is kind of like working with a corpus of a language where every possible sentence only occurs once, thus all are equally plausible. <br> 2. The model helps you learn. Not only do you get immediate feedback, if you get something wrong, the same sentence will be displayed again (with a different word missing) a few sentences later. <br> 3. You are only asked to generate one-word answers.</blockquote> Additionally, more sophisticated models like ChatGPT <a href="https://openai.com/blog/chatgpt">include an additional fine-tuning stage based on human feedback</a>. Incidentally, this turns out to be a <a href="https://time.com/6247678/openai-chatgpt-kenya-workers/">great opportunity to exploit workers in the global south for cheap labor</a>.' },
